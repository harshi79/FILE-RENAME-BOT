...
HELP_PAGES = [
    ...
    # Page 5 — History / Cancel / Settings
    (
        "📖 <b>ʜᴇʟᴘ — ʜɪꜱᴛᴏʀʏ / ᴄᴀɴᴄᴇʟ / ꜱᴇᴛᴛɪɴɢꜱ</b> (5/6)\n\n"
        "• <b>📜 ʜɪꜱᴛᴏʀʏ</b> — ᴠɪᴇᴡ ᴘᴀꜱᴛ ʀᴇɴᴀᴍᴇꜱ (ᴘᴀɢɪɴᴀᴛᴇᴅ). ᴜꜱᴇꜰᴜʟ ᴛᴏ ᴄʜᴇᴄᴋ ᴘʀᴇᴠɪᴏᴜꜱ ᴊᴏʙꜱ.\n"
        "• <b>❌ ᴄᴀɴᴄᴇʟ</b> — ᴄʟᴇᴀʀꜱ ᴄᴜʀʀᴇɴᴛ ꜱᴛᴀᴛᴇ ᴏʀ ᴄᴀɴᴄᴇʟꜱ ᴀᴄᴛɪᴠᴇ ᴊᴏʙꜱ. ᴜꜱᴇ ɪꜰ ꜱᴛᴜᴄᴋ.\n"
        "• <b>⚙️ ꜱᴇᴛᴛɪɴɢꜱ</b> — ᴛᴏɢɢʟᴇ ᴄᴀꜱᴇ / ᴡꜱ / ɴᴜᴍ ꜰᴏʀᴍᴀᴛ. ᴀᴘᴘʟɪᴇᴅ ᴛᴏ ꜰᴜᴛᴜʀᴇ ʙᴀᴛᴄʜᴇꜱ.\n"
        "ᴜꜱᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ᴏʀ ᴍᴇɴᴜ ʙᴜᴛᴛᴏɴꜱ."
    ),
